...
CACHE_ROOT="${F015_CACHE_DIR:-${F013_CACHE_DIR:-${ROOT}/workspace/cache/xforce_dockers/uncensored_creative01}}"
WHEELHOUSE="${F013_WHEELHOUSE:-${CACHE_ROOT}/wheelhouse}"
ARTIFACT_DIR="${F013_ARTIFACT_DIR:-${CACHE_ROOT}/artifacts}"
...
PIP_CACHE_DIR="${PIP_CACHE_DIR:-${CACHE_ROOT}/pip-cache}"
